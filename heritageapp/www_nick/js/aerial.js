			...
			if(aerial_image_list == null){
					...
					var query = AzureTable.where({}).read().done(function (results) {
						...
						var mySwiper = new Swiper ('.swiper-container', {
  						...
  						localStorage.aerial_image_list = JSON.stringify(aerial_image_list);        
						}, function (err) {
						if(!(typeof localStorage.aerial_image_list === 'undefined'))
    						aerial_image_list = JSON.parse(localStorage.aerial_image_list);
