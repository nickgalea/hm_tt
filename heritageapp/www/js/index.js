...
function onBackKeyDown() {
   ...
   //console.log(de);
    ...
    if(stack.length==0)
    {
      var lang = $("#language").is(":visible");
      var cont = $("#contact-us").is(":visible");
      console.log(lang);
...
function hidePadlocks(){
  ...
  if(prem_product)
  {
    ...
    $(".pad_to_change").attr("src","img/icons/compass106.png");
  }
}
...
app.config(function($routeProvider){
    ...
    .when('/history_excavation', {
                templateUrl: 'history_excavation.html'
        })
    .when('/artvid', {
